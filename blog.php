        ...
        <div class="row">
            ...
            <div class="col-sm-8 mt-3">
                ...
                if (isset($_GET["pretrazi"])) {
                    // KADA PRETRAZUJEMO blog.php?stranica=...
            ...
            OR post LIKE :search ";
                    ...
                    //KADA POKUSAVAMO NEDEFINISANOJ STRANICI blog.php?stranica=PRAZNO
                    $sql = "SELECT * FROM postovi WHERE kategorija=:kategorija";
                    $stmt = $con->prepare($sql);
                    $stmt->bindValue(":kategorija", $_GET["kategorija"]);
                    $stmt->execute();
                }
                ...
                ?>
                    ...
                    //BROJ KOMENTARA
                    $con;
                    $sql1 = "SELECT COUNT(id) AS br FROM komentari WHERE postid=$id AND status='on'";
...
background: radial-gradient(circle, rgba(55,62,64,0.8520542005864846) 21%, rgba(183,213,212,1) 100%);   ">
                        <div class="card-body">
                            ...
                            <h3 class="card-title" style="       font-family: 'Archivo Black',sans-serif; color:#373e40;text-shadow:0 0 1px #b7d5d4,0 0 1px #b7d5d4,0 0 1px #b7d5d4,0 0 1px #b7d5d4; "><?php echo htmlentities($naslov); ?><span style="float:right;" class="badge badge-dark text-light"><i class="fas fa-comments"></i> <?php echo $br["br"]; ?></span></h4>
                            <hr>
